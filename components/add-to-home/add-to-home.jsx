...
export default function AddToHomeScreenPrompt() {
    ...
    useEffect(() => {
        ...
        // This is the primary check to see if the app is already running as an installed PWA.
        ...
        return () => {
            // Only remove listener if it was potentially added (i.e., not iOS)
             if (!currentOSIsIOS) { // Use the value determined in this effect's closure
        ...
        return (
            <div className={styles.addToHomeScreenPrompt}>
                ...
                <p className={styles.promptInstructions}>
                    Tocca l&apos;icona &quot;Condividi&quot; <Image src={shareIcon} alt="Icona Condividi iOS" style={{verticalAlign: 'middle', margin: '0 0.2em'}} width={20} height={16} /> (o Opzioni) e poi &quot;Aggiungi a Home&quot;.
                </p>
    ...
    return (
        <div className={styles.addToHomeScreenPrompt}>
            ...
            <div className={styles.promptActions}>
                ...
                <button
                    onClick={handleDismissClick}
                    className={styles.dismissInstall}
                >
                    Versione Web
                </button>
            </div>
